              ...
              <DialogPanel
                ...
                <form @submit.prevent="onSubmit">
                  ...
                  <footer class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex-row-reverse">
                    ...
                    <button @click="closeModal()" type="submit" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm
                             bg-white  hover:bg-gray-50 focus:ring-indigo-500">
                      cancel
                    </button>
                  </footer>
                </form>
