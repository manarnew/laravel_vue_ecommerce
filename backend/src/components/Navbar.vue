<template>
    <header class="flex justify-between items-center p-4 h-14 shadow bg-white">
      <button @click="emit('toggle-sidebar')" class="flex items-center justify-content rounded transition-colors w-8 h-8 text-gray-700 hover:bg-black/10">
            ...
            <MenuItems
              ...
              <div class="px-1 py-1">
                ...
                <button @click="logout" :class="[
                  ...
                  <ArrowLongUpIcon :active="active" class="mr-2 h-5 w-5 text-violet-400" aria-hidden="true" />
                  Logout
                </button>
                </MenuItem>
              </div>
  ...
  <script setup>
    import {AdjustmentsHorizontalIcon,ArrowLongUpIcon,UserIcon} from '@heroicons/vue/24/outline'
